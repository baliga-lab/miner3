...
def test_cluster_quality():
    ...
    TFBSDB
    """
    database_path = 'miner_mindata/network_dictionaries/tfbsdb_tf_to_genes.pkl'
    with open('miner_mindata/network_dictionaries/tfbsdb_tf_to_genes.pkl', 'rb') as infile:
